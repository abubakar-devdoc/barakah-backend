...
// On Vercel, the platform invokes the Express app as a serverless function
// via `api/index.ts`. Do not listen, open Socket.io, or start node-cron.
if (process.env.VERCEL) {
  logger.info('Running in Vercel serverless mode (HTTP only; sockets/cron via platform)');
} else {
